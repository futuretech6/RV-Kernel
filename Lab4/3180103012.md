...
15. `x 0x800002ec`(trap_s物理地址)正常但是`x 0xffffffe0000002ec`却是"Cannot access memory at address 0xffffffe0000002ec"，且satp正常，说明等值映射成功了但是高位映射失败了。
     * 将paging_init改为先高位映射再等值映射，出现了相反的结果，0x8...无法访问但是虚拟空间正常
     * 
